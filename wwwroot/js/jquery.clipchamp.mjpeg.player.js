...
(function ($) {
    ...
    function splitMJPEG(mjpegUrl, callback) {
        ...
        xhr.open('GET', "https://192.168.88.60/cgi-bin/mjpg/video.cgi?channel=1&subtype=1", true);
        xhr.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
        xhr.setRequestHeader('Access-Control-Allow-Origin', '*');
        xhr.setRequestHeader('Access-Control-Allow-Methods', 'POST, GET, OPTIONS, PUT, DELETE');
        xhr.setRequestHeader('Access-Control-Allow-Headers', 'Content-Type, Accept, Authorization, X-Requested-With, Cache-Control');
        xhr.setRequestHeader('Authorization', 'Basic ' + btoa('admin:megafaYakand'));
        xhr.mode = "no-cors";
