...
namespace mYPMS.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<IdentityUser> signInManager, ILogger<LoginModel> logger, RoleManager<IdentityRole> roleManager, UserManager<IdentityUser> userManager)
        {
            ...
            if (userManager.Users.Where(u => u.UserName == "Admin" || u.NormalizedUserName == "ADMIN").FirstOrDefault() == null)
            {
                IdentityUser user = new("Admin")
                {
                    NormalizedUserName = "ADMIN"
                };
                var identityResult = userManager.CreateAsync(user, "admin").Result;
                if (identityResult.Succeeded) _ = userManager.AddToRoleAsync(user, "Admin").Result;
            }
        }
